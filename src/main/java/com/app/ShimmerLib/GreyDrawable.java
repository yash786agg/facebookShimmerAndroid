...
{
    private final static int DEFAULT_GREY = Color.argb(50, 200, 200, 200);
    private final static int DARKER_GREY = Color.argb(160, 180, 180, 180);

    private final static int DEFAULT_GREY_BOLD = Color.argb(50, 180, 180, 180);
    private final static int DARKER_GREY_BOLD = Color.argb(180, 150, 150, 150);

    private final static int DURATION = 750;
    private final static int STOP_DURATION = 200;

    private boolean fadein = false;

    private int grayColor = DEFAULT_GREY;
